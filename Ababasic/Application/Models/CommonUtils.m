...
static int trialsCount = 0;
static int answer = -1;
static NSString *promptLevel;
static NSString *language;
static NSString *favor_word;
...
+ (void) setFavoriteWord:(NSString *)w
{
    favor_word = w;
}

+ (NSString *) getFavoriteWord
{
    return favor_word;
}

+ (void) setGuestState:(Boolean) flag { isGuest = flag; }

+ (Boolean) getGuestState { return isGuest; }
